...
double f(double x){return 2 * pow(x-1,2) - pow(2.7182,x);}
double fi(double x){return  (2*pow(x,2)+2 -pow(2.7182,x))/4;}
double fd1(double x) { return 4 * x - 4 - pow(2.7182, x); }
double fd2(double x) { return 4 - pow(2.7182, x); }
